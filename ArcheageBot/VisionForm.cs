    ...
    class VisionForm
    {
        ...
        public static int? FindForm(List<List<VisionForm>> Forms, int StartX, int StartY)
        {
            ...
            for (int CurrentFormCount = 0; CurrentFormCount < Forms.Count; ++CurrentFormCount)
               // Parallel.For(0, Forms[CurrentFormCount].Count,i =>
            {
                ...
                Parallel.For(0, Forms[CurrentFormCount].Count,i =>
            {
                ...
                CurrentColor = Color.FromArgb(GetPixel(Program.Archeage, StartX + Forms[CurrentFormCount][i].OffsetX, StartY + Forms[CurrentFormCount][i].OffsetY));
